Nova 2001 Arcade for the ANTMINER S9 ZYNQ-7010 FPGA Board. Pinballwiz 2026
Code from Mister-X.
...
Build:
* Obtain correct roms file for Nova2001(h) (see scripts in tools folder for rom details).
* Unzip rom files to the tools folder.
* Run the make nova2001 proms script in the tools folder.
* Place the generated prom files inside the proms folder.
* Open the ANTMINER-Raiders5 project file using Vivado (v2022.2 or silimar is recommended)
