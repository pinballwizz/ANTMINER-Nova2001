...
wire		fgv_CLK =  SHCLK;//hs_access ? ROMCL : SHCLK;
wire [10:0]	fgv_ADR = CPADR[10:0];//hs_access ? hs_address[10:0] : CPADR[10:0];
wire		fgv_WRT = (CS_FGV & CPWRT);//hs_access ? hs_write : (CS_FGV & CPWRT);
wire  [7:0]	fgv_DIN = CPODT;//hs_access ? hs_data_in : CPODT;
wire  [7:0]	fgv_DOUT;
assign hs_data_out = 8'h00;//hs_access ? fgv_DOUT : 8'h00;
assign FGDAT = fgv_DOUT;//hs_access ? 8'h00 : fgv_DOUT;
