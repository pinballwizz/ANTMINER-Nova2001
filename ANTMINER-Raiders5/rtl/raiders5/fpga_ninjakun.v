...
//	input	  [7:0]	DSW2,
//	input 	  [1:0] HWTYPE, 	// 00=ninjakun, 01=Raiders5, 10=nova2001
...
wire	  [7:0]	DSW1 = 8'b10011100;
wire	  [7:0]	DSW2 = 8'b11001111; 
wire      [1:0] HWTYPE = 2'b10;
wire             pause = 1'b0; 
...
wire		ram_CLK = SHCLK;//hs_access ? ROMCL : SHCLK;
wire [10:0]	ram_ADR = CP0AD[10:0];//hs_access ? hs_address[10:0] : CP0AD[10:0];
wire		ram_WRT = (CS_SH0 & CP0WR);//hs_access ? hs_write : (CS_SH0 & CP0WR);
wire  [7:0]	ram_DIN = CP0OD;//hs_access ? hs_data_in : CP0OD;
wire  [7:0]	ram_DOUT;
wire [7:0] SHDT0, SHDT1;
//assign hs_data_out = hs_access ? ram_DOUT : 8'h00;
assign SHDT0 = ram_DOUT;//hs_access ? 8'h00 : ram_DOUT;
